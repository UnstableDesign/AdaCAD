...
const mysql_keywords_js_1 = require("./mysql.keywords.js");
const mysql_functions_js_1 = require("./mysql.functions.js");
...
const standardOnelineClauses = (0, expandPhrases_js_1.expandPhrases)(['CREATE [TEMPORARY] TABLE [IF NOT EXISTS]']);
...
exports.mysql = {
    ...
    tokenizerOptions: {
        ...
        reservedPhrases,
        supportsXor: true,
        reservedKeywords: mysql_keywords_js_1.keywords,
        reservedDataTypes: mysql_keywords_js_1.dataTypes,
        reservedFunctionNames: mysql_functions_js_1.functions,
