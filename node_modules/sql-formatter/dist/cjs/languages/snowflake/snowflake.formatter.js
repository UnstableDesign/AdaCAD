...
const snowflake_functions_js_1 = require("./snowflake.functions.js");
const snowflake_keywords_js_1 = require("./snowflake.keywords.js");
...
const reservedSetOperations = (0, expandPhrases_js_1.expandPhrases)(['UNION [ALL]', 'MINUS', 'EXCEPT', 'INTERSECT']);
...
exports.snowflake = {
    ...
    tokenizerOptions: {
        ...
        reservedJoins,
        reservedPhrases,
        reservedKeywords: snowflake_keywords_js_1.keywords,
        reservedDataTypes: snowflake_keywords_js_1.dataTypes,
        reservedFunctionNames: snowflake_functions_js_1.functions,
        stringTypes: ['$$', `''-qq-bs`],
        identTypes: ['""-qq'],
        variableTypes: [
