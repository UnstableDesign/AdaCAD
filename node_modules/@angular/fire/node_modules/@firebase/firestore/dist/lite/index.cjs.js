 ...
 */ function connectFirestoreEmulator(t, e, r, n = {}) {
    ...
    s && (pingServer(`https://${u}`), updateEmulatorBanner("Firestore", !0)), o.host !== ot && o.host !== u && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
 ...
 */ !function __PRIVATE_registerFirestore() {
    ...
    registerVersion("firestore-lite", P, ""), registerVersion("firestore-lite", P, "cjs2017");
}();
