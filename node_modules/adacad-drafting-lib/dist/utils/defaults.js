...
exports.setMaxArea = exports.setLCMTimeout = exports.licenses = exports.paste_options = exports.mixer_edit_mode = exports.draft_edit_mode = exports.draft_pencil = exports.draft_edit_source = exports.density_units = exports.loom_types = exports.draft_view_modes = exports.origin_option_list = exports.rendering_color_defaults = exports.defaults = void 0;
exports.defaults = {
...
exports.rendering_color_defaults = [
    {
        id: 'down',
        r: 255,
        g: 255,
...
const setLCMTimeout = (timeout) => {
    exports.defaults.lcm_timeout = timeout;
};
exports.setLCMTimeout = setLCMTimeout;
//add this one function so we can set this globally from the UI if need be
const setMaxArea = (max_area) => {
    exports.defaults.max_area = max_area;
};
exports.setMaxArea = setMaxArea;
