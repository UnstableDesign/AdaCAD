...
const perform = (op_params, op_inputs) => {
    ...
    const repeat = (0, operations_1.getOpParamValById)(2, op_params);
    ...
    let width, height = 0;
    if (repeat) {
        height = (0, utils_1.lcm)([(0, draft_1.wefts)(draft_a.drawdown), (0, draft_1.wefts)(draft_b.drawdown)], utils_1.defaults.lcm_timeout);
        width = (0, utils_1.lcm)([(0, draft_1.warps)(draft_a.drawdown), (0, draft_1.warps)(draft_b.drawdown)], utils_1.defaults.lcm_timeout);
    }
    else {
        height = Math.max((0, draft_1.wefts)(draft_b.drawdown) + shift_pics, (0, draft_1.wefts)(draft_a.drawdown));
        width = Math.max((0, draft_1.warps)(draft_b.drawdown) + shift_ends, (0, draft_1.warps)(draft_a.drawdown));
    }
    //offset draft b:
    ...
    for (let i = 0; i < height; i++) {
        ...
        if (!repeat) {
            ...
            const ndx = (i + shift_pics) % (0, draft_1.wefts)(draft_b.drawdown);
...
const generateName = (param_vals, op_inputs) => {
    ...
    return 'diff' + (0, operations_1.parseDraftNames)(drafts) + ")";
};
...
exports.diff = { name, meta, params, inlets, perform, generateName, sizeCheck };
