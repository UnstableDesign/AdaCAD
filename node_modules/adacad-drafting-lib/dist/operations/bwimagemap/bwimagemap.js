...
const perform = (op_params, op_inputs) => {
    ...
    const color_to_drafts = data.colors.map((color) => {
        ...
        if (child_of_color === undefined) {
            if (color.hex == '#000000')
                return { color: color.hex, draft: (0, draft_1.initDraftWithParams)({ warps: 1, wefts: 1, drawdown: [[(0, draft_1.createCell)(true)]] }) };
            else
                return { color: color.hex, draft: (0, draft_1.initDraftWithParams)({ warps: 1, wefts: 1, drawdown: [[(0, draft_1.createCell)(false)]] }) };
            ;
        }
        else
            return { color: color.hex, draft: child_of_color.drafts[0] };
    });
    if (color_to_drafts === undefined)
...
exports.bwimagemap = { name, meta, params, inlets, dynamic_param_id, dynamic_param_type, perform, generateName, onParamChange, sizeCheck };
//# sourceMappingURL=bwimagemap.js.map