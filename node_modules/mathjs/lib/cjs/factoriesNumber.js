...
// arithmetic
var createUnaryMinus = exports.createUnaryMinus = /* #__PURE__ */createNumberFactory('unaryMinus', _index.unaryMinusNumber);
var createUnaryPlus = exports.createUnaryPlus = /* #__PURE__ */createNumberFactory('unaryPlus', _index.unaryPlusNumber);
var createAbs = exports.createAbs = /* #__PURE__ */createNumberFactory('abs', _index.absNumber);
var createAddScalar = exports.createAddScalar = /* #__PURE__ */createNumberFactory('addScalar', _index.addNumber);
var createSubtractScalar = exports.createSubtractScalar = /* #__PURE__ */createNumberFactory('subtractScalar', _index.subtractNumber);
var createCbrt = exports.createCbrt = /* #__PURE__ */createNumberFactory('cbrt', _index.cbrtNumber);
var createCube = exports.createCube = /* #__PURE__ */createNumberFactory('cube', _index.cubeNumber);
var createExp = exports.createExp = /* #__PURE__ */createNumberFactory('exp', _index.expNumber);
var createExpm1 = exports.createExpm1 = /* #__PURE__ */createNumberFactory('expm1', _index.expm1Number);
var createGcd = exports.createGcd = /* #__PURE__ */createNumberFactory('gcd', _index.gcdNumber);
var createLcm = exports.createLcm = /* #__PURE__ */createNumberFactory('lcm', _index.lcmNumber);
var createLog10 = exports.createLog10 = /* #__PURE__ */createNumberFactory('log10', _index.log10Number);
var createLog2 = exports.createLog2 = /* #__PURE__ */createNumberFactory('log2', _index.log2Number);
var createMod = exports.createMod = /* #__PURE__ */createNumberFactory('mod', _index.modNumber);
var createMultiplyScalar = exports.createMultiplyScalar = /* #__PURE__ */createNumberFactory('multiplyScalar', _index.multiplyNumber);
var createMultiply = exports.createMultiply = /* #__PURE__ */createNumberFactory('multiply', _index.multiplyNumber);
var createNthRoot = exports.createNthRoot = /* #__PURE__ */
createNumberOptionalSecondArgFactory('nthRoot', _index.nthRootNumber);
var createSign = exports.createSign = /* #__PURE__ */createNumberFactory('sign', _index.signNumber);
var createSqrt = exports.createSqrt = /* #__PURE__ */createNumberFactory('sqrt', _index.sqrtNumber);
var createSquare = exports.createSquare = /* #__PURE__ */createNumberFactory('square', _index.squareNumber);
var createSubtract = exports.createSubtract = /* #__PURE__ */createNumberFactory('subtract', _index.subtractNumber);
var createXgcd = exports.createXgcd = /* #__PURE__ */createNumberFactory('xgcd', _index.xgcdNumber);
var createDivideScalar = exports.createDivideScalar = /* #__PURE__ */createNumberFactory('divideScalar', _index.divideNumber);
var createPow = exports.createPow = /* #__PURE__ */createNumberFactory('pow', _index.powNumber);
var createRound = exports.createRound = /* #__PURE__ */
createNumberOptionalSecondArgFactory('round', _index.roundNumber);
var createLog = exports.createLog = /* #__PURE__ */
createNumberOptionalSecondArgFactory('log', _index.logNumber);
var createLog1p = exports.createLog1p = /* #__PURE__ */createNumberFactory('log1p', _index.log1pNumber);
var createAdd = exports.createAdd = /* #__PURE__ */createNumberFactory('add', _index.addNumber);
var createNorm = exports.createNorm = /* #__PURE__ */createNumberFactory('norm', _index.normNumber);
var createDivide = exports.createDivide = /* #__PURE__ */createNumberFactory('divide', _index.divideNumber);

// bitwise
var createBitAnd = exports.createBitAnd = /* #__PURE__ */createNumberFactory('bitAnd', _index.bitAndNumber);
var createBitNot = exports.createBitNot = /* #__PURE__ */createNumberFactory('bitNot', _index.bitNotNumber);
var createBitOr = exports.createBitOr = /* #__PURE__ */createNumberFactory('bitOr', _index.bitOrNumber);
var createBitXor = exports.createBitXor = /* #__PURE__ */createNumberFactory('bitXor', _index.bitXorNumber);
var createLeftShift = exports.createLeftShift = /* #__PURE__ */createNumberFactory('leftShift', _index.leftShiftNumber);
var createRightArithShift = exports.createRightArithShift = /* #__PURE__ */createNumberFactory('rightArithShift', _index.rightArithShiftNumber);
var createRightLogShift = exports.createRightLogShift = /* #__PURE__ */createNumberFactory('rightLogShift', _index.rightLogShiftNumber);
...
// logical
var createAnd = exports.createAnd = /* #__PURE__ */createNumberFactory('and', _index.andNumber);
var createNot = exports.createNot = /* #__PURE__ */createNumberFactory('not', _index.notNumber);
var createOr = exports.createOr = /* #__PURE__ */createNumberFactory('or', _index.orNumber);
var createXor = exports.createXor = /* #__PURE__ */createNumberFactory('xor', _index.xorNumber);

// matrix

// FIXME: create a lightweight "number" implementation of subset only supporting plain objects/arrays
var createIndex = exports.createIndex = /* #__PURE__ */(0, _factory.factory)('index', [], function () {
  return _noop.noIndex;
});
var createMatrix = exports.createMatrix = /* #__PURE__ */(0, _factory.factory)('matrix', [], function () {
  return _noop.noMatrix;
}); // FIXME: needed now because subset transform needs it. Remove the need for it in subset
var createSubset = exports.createSubset = /* #__PURE__ */(0, _factory.factory)('subset', [], function () {
...
var createLgamma = exports.createLgamma = createNumberFactory('lgamma', _index.lgammaNumber);
...
// trigonometry
var createAcos = exports.createAcos = /* #__PURE__ */createNumberFactory('acos', _index.acosNumber);
var createAcosh = exports.createAcosh = /* #__PURE__ */createNumberFactory('acosh', _index.acoshNumber);
var createAcot = exports.createAcot = /* #__PURE__ */createNumberFactory('acot', _index.acotNumber);
var createAcoth = exports.createAcoth = /* #__PURE__ */createNumberFactory('acoth', _index.acothNumber);
var createAcsc = exports.createAcsc = /* #__PURE__ */createNumberFactory('acsc', _index.acscNumber);
var createAcsch = exports.createAcsch = /* #__PURE__ */createNumberFactory('acsch', _index.acschNumber);
var createAsec = exports.createAsec = /* #__PURE__ */createNumberFactory('asec', _index.asecNumber);
var createAsech = exports.createAsech = /* #__PURE__ */createNumberFactory('asech', _index.asechNumber);
var createAsin = exports.createAsin = /* #__PURE__ */createNumberFactory('asin', _index.asinNumber);
var createAsinh = exports.createAsinh = /* #__PURE__ */createNumberFactory('asinh', _index.asinhNumber);
var createAtan = exports.createAtan = /* #__PURE__ */createNumberFactory('atan', _index.atanNumber);
var createAtan2 = exports.createAtan2 = /* #__PURE__ */createNumberFactory('atan2', _index.atan2Number);
var createAtanh = exports.createAtanh = /* #__PURE__ */createNumberFactory('atanh', _index.atanhNumber);
var createCos = exports.createCos = /* #__PURE__ */createNumberFactory('cos', _index.cosNumber);
var createCosh = exports.createCosh = /* #__PURE__ */createNumberFactory('cosh', _index.coshNumber);
var createCot = exports.createCot = /* #__PURE__ */createNumberFactory('cot', _index.cotNumber);
var createCoth = exports.createCoth = /* #__PURE__ */createNumberFactory('coth', _index.cothNumber);
var createCsc = exports.createCsc = /* #__PURE__ */createNumberFactory('csc', _index.cscNumber);
var createCsch = exports.createCsch = /* #__PURE__ */createNumberFactory('csch', _index.cschNumber);
var createSec = exports.createSec = /* #__PURE__ */createNumberFactory('sec', _index.secNumber);
var createSech = exports.createSech = /* #__PURE__ */createNumberFactory('sech', _index.sechNumber);
var createSin = exports.createSin = /* #__PURE__ */createNumberFactory('sin', _index.sinNumber);
var createSinh = exports.createSinh = /* #__PURE__ */createNumberFactory('sinh', _index.sinhNumber);
var createTan = exports.createTan = /* #__PURE__ */createNumberFactory('tan', _index.tanNumber);
var createTanh = exports.createTanh = /* #__PURE__ */createNumberFactory('tanh', _index.tanhNumber);

// transforms

var createSubsetTransform = exports.createSubsetTransform = /* #__PURE__ */(0, _factory.factory)('subset', [], function () {
  return _noop.noSubset;
}, {
...
var createIsInteger = exports.createIsInteger = /* #__PURE__ */createNumberFactory('isInteger', _index.isIntegerNumber);
var createIsNegative = exports.createIsNegative = /* #__PURE__ */createNumberFactory('isNegative', _index.isNegativeNumber);
var createIsPositive = exports.createIsPositive = /* #__PURE__ */createNumberFactory('isPositive', _index.isPositiveNumber);
var createIsZero = exports.createIsZero = /* #__PURE__ */createNumberFactory('isZero', _index.isZeroNumber);
var createIsNaN = exports.createIsNaN = /* #__PURE__ */createNumberFactory('isNaN', _index.isNaNNumber);
