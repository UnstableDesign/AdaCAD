...
const perform = (op_params, op_inputs) => {
    ...
    for (let i = 0; i < height; i++) {
        ...
        seq_a.computeFilter('atop', seq_b);
...
const generateName = (param_vals, op_inputs) => {
    ...
    return 'atop' + (0, operations_1.parseDraftNames)(drafts) + ")";
};
...
exports.atop = { name, meta, params, inlets, perform, generateName, sizeCheck };
//# sourceMappingURL=atop.js.map