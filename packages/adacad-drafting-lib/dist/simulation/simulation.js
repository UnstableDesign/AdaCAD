...
exports.getWeftPath = exports.getFlatVtxList = exports.parseWeftPaths = exports.initWeftPaths = exports.calcWarpVertexZ = exports.calcWeftVertexZ = exports.getClosestBlockingVertex = exports.smoothPick = exports.computeYAdjustment = exports.computeThetaBetweenVertices = exports.computeThetaMax = exports.calcWeftVertexY = exports.calcWarpVertexY = exports.getVertexForCN = exports.getBlockingFloatsForACN = exports.calculateYRepel = exports.getRepelForceAtVtx = exports.getYOfBlockingVtx = exports.getBlockingVtx = exports.getFloatVtxRight = exports.getFloatVtxLeft = exports.getYarnHeightOffset = exports.getMaterialFromPath = exports.hasBlockingVtx = exports.getBeatDistance = exports.calcX = exports.getDraftTopology = exports.isolateLayers = exports.getFloats = exports.printFloats = exports.pullRow = exports.pullRows = exports.updateCNs = exports.setFloatBlocking = exports.getAllWeftFloats = exports.getClosestACNOnWeft = exports.initContactNeighborhoods = exports.getFloatRelationships = exports.getFloatsAffectedByLifting = exports.getUntouchedFloatsInRange = exports.classifyNodeTypeBasedOnFaces = exports.getNextCellOnLayer = exports.getAttachedFloats = exports.getWeftFloat = exports.getColAsFloats = exports.getRowAsFloats = exports.layerNotSet = exports.getLayer = exports.getNodeType = exports.computeSimulationData = void 0;
exports.printYValues = exports.printCNs = exports.calcClothHeightOffsetFactor = exports.followTheWefts = exports.placeWarps = exports.pruneWeftsAndSetCNBlocking = exports.pruneWarps = exports.getWarpLayer = exports.getWeftLayer = exports.reduceVerticesAndSetOrientation = exports.pruneDuplicateWarpVertices = exports.pruneDuplicateWeftVertices = exports.getOrientation = exports.addPlaceholderVertices = exports.getMaxY = exports.getMinY = exports.createWarpPathFromWeftPaths = void 0;
 ...
 * @returns
 */
const computeSimulationData = async (draft, simVars, topo, floats, wefts, warps) => {
    const simData = {
        draft: draft,
        topo: topo !== null && topo !== void 0 ? topo : [],
        wefts: wefts !== null && wefts !== void 0 ? wefts : [],
        warps: warps !== null && warps !== void 0 ? warps : []
    };
    if (simData.topo.length == 0) {
        simData.topo = await (0, exports.getDraftTopology)(simData.draft, simVars);
    }
    if (simData.wefts.length == 0)
        simData.wefts = await (0, exports.followTheWefts)(simData.draft, simData.topo, simVars);
    if (simData.warps.length == 0)
        simData.warps = await (0, exports.placeWarps)(simData.draft, simData.wefts, simData.topo, simVars);
    return Promise.resolve(simData);
};
exports.computeSimulationData = computeSimulationData;
// CONTACT NEIGHBORHOOD UTILITIES // 
const setIndex = (ndx, warps, cns) => {
    const cn = getCN(ndx, warps, cns);
    cn.ndx = ndx;
    return cns;
};
const setFace = (ndx, warps, cns, value) => {
    const cn = getCN(ndx, warps, cns);
    cn.face = value;
    return cns;
};
const getFace = (ndx, warps, cns) => {
    const cn = getCN(ndx, warps, cns);
    return cn.face;
};
const setNodeType = (ndx, warps, cns, type) => {
    const cn = getCN(ndx, warps, cns);
    cn.node_type = type;
    return cns;
};
const getNodeType = (ndx, warps, cns) => {
    const cn = getCN(ndx, warps, cns);
    return cn.node_type;
};
...
//     return cn.mv.y;
// }
const setLayer = (ndx, warps, cns, layer) => {
    if (ndx.j < 0 || ndx.j >= warps)
        return cns;
    const cn = getCN(ndx, warps, cns);
    cn.layer = layer;
    return cns;
};
const getLayer = (ndx, warps, cns) => {
    const cn = getCN(ndx, warps, cns);
    return cn.layer;
};
exports.getLayer = getLayer;
const layerNotSet = (i, j, id, warps, cns) => {
...
exports.layerNotSet = layerNotSet;
const getCN = (ndx, warps, cns) => {
    const ndx_flat = 4 * (ndx.i * warps + ndx.j) + ndx.id;
    return cns[ndx_flat];
};
const setAndOppositeFaces = (f1, f2) => {
    if (f1 == null || f2 == null)
        return false;
    return (f1 !== f2);
};
const setAndSameFaces = (f1, f2) => {
    if (f1 == null || f2 == null)
        return false;
    return (f1 == f2);
};
 ...
 * @returns
 */
const getRowAsFloats = (i, warps, cns) => {
    const floats = [];
    ...
    if (lefts.length !== rights.length)
        console.error("THIS ROW HAS AN UNEVEN NUMBER OF ACNS");
    lefts.forEach(left => {
        let found = false;
...
exports.getRowAsFloats = getRowAsFloats;
/**
 ...
 * @returns
 */
const getColAsFloats = (j, wefts, warps, cns) => {
    const floats = [];
    ...
    if (lefts.length !== rights.length)
        console.error("THIS COL HAS AN UNEVEN NUMBER OF ACNS");
    lefts.forEach(left => {
        let found = false;
...
exports.getColAsFloats = getColAsFloats;
const checkWarpIndexInRange = (i, j, wefts, float) => {
    if (float.face == false || float.face == null)
        return false;
    if (float.left.j !== j)
        return false;
    if (float.right.i < wefts) {
        ...
        return (i >= 0 && i <= (0, utils_1.modStrict)(float.right.i, wefts)) || (i >= float.left.i && i < wefts);
    }
};
/**
 ...
 * @param j
 */
const getWarpFloat = (i, j, wefts, warps, all_floats) => {
    i = (0, utils_1.modStrict)(i, wefts);
    j = (0, utils_1.modStrict)(j, warps);
 ...
 * @returns
 */
const alignCoordinates = (ar, al, fr, fl, warps) => {
 ...
 * @returns
 */
const checkWeftIndexInRange = (j, warps, float) => {
    if (float.face == null)
        return false;
 ...
 */
const getWeftFloat = (i, j, wefts, warps, all_floats) => {
    i = (0, utils_1.modStrict)(i, wefts);
    j = (0, utils_1.modStrict)(j, warps);
...
exports.getWeftFloat = getWeftFloat;
const getWeftFloatLength = (f, warps) => {
    if (f.right.j >= f.left.j)
        return f.right.j - f.left.j;
    else
        return warps - f.left.j + f.right.j;
};
const getWarpFloatLength = (f, wefts) => {
    if (f.right.i >= f.left.i)
        return f.right.i - f.left.i;
    else
        return wefts - f.left.i + f.right.i;
};
/**
 ...
 * @returns
 */
const getAttachedFloats = (i, float, warps, all_floats) => {
    const attached = [];
...
exports.getAttachedFloats = getAttachedFloats;
/**
 ...
 * @returns
 */
const getNextCellOnLayer = (i, j, wefts, warps, layer, direction, cns) => {
    const i_base = i;
    const j_base = j;
    switch (direction) {
        case "above":
            for (let i_offset = 1; i_offset < wefts - 1; i_offset++) {
                const i_adj = (0, utils_1.modStrict)(i_base - i_offset, wefts);
                if ((0, exports.getLayer)({ i: i_adj, j, id: 0 }, warps, cns) == layer) {
                    return { i: i_adj, j };
                }
            }
            return null;
        ...
        case "left":
            for (let j_offset = 1; j_offset < warps - 1; j_offset++) {
                const j_adj = (0, utils_1.modStrict)(j_base - j_offset, warps);
                if ((0, exports.getLayer)({ i, j: j_adj, id: 0 }, warps, cns) == layer) {
                    return { i, j: j_adj };
                }
            }
            return null;
...
exports.getNextCellOnLayer = getNextCellOnLayer;
/**
 ...
 * @returns
 */
const classifyNodeTypeBasedOnFaces = (f1, f2, ndx, warps, cns) => {
...
exports.classifyNodeTypeBasedOnFaces = classifyNodeTypeBasedOnFaces;
// LAYER PARSING
/**
 ...
 * @param fs
 */
const getUntouchedFloatsInRange = (i, j, all_floats, wefts, warps) => {
    const candidates = [];
    let in_range = [];
    //unwrap the range
    if (i.l > i.r) {
    ...
    for (let x = i.l; x <= i.r; x++) {
        for (let y = j.l; y <= j.r; y++) {
            const adj_i = (0, utils_1.modStrict)(x, wefts);
            const adj_j = (0, utils_1.modStrict)(y, warps);
            const weft = (0, exports.getWeftFloat)(adj_i, adj_j, wefts, warps, all_floats.map(f => f.float));
            if (weft !== null)
                candidates.push(weft);
            const warp = getWarpFloat(adj_i, adj_j, wefts, warps, all_floats.map(f => f.float));
            if (warp !== null)
                candidates.push(warp);
        }
    }
    in_range = candidates.map(el => getFloatIndex(el, all_floats)).filter(el => el !== -1 && !all_floats[el].touched);
    return in_range;
};
exports.getUntouchedFloatsInRange = getUntouchedFloatsInRange;
const rowHasActiveCNs = (i, warps, cns) => {
 ...
 * @returns
 */
const getFloatsAffectedByLifting = (id, all_floats, wefts, warps, limit) => {
    let attached = [];
    const float_with_id = all_floats.find(el => el.id == id);
    if (float_with_id == undefined)
        return [];
    ...
    if (float.face) {
        ...
        if ((getWarpFloatLength(float, wefts) + (limit * 2)) >= wefts) {
            ...
            i_range = { l: (0, utils_1.modStrict)(float.left.i - limit, wefts), r: (0, utils_1.modStrict)(float.right.i + limit, wefts) };
        }
        ...
        if (getWeftFloatLength(float, warps) + limit * 2 >= warps) {
            ...
            j_range = { l: (0, utils_1.modStrict)(float.left.j - limit, warps), r: (0, utils_1.modStrict)(float.right.j + limit, warps) };
        }
        i_range = { l: float.left.i, r: float.right.i };
    }
    attached = (0, exports.getUntouchedFloatsInRange)(i_range, j_range, all_floats, wefts, warps);
    attached = (0, utils_1.filterToUniqueValues)(attached);
    attached = attached.filter(el => el !== id); //filter out the float that called the function
    return attached;
};
exports.getFloatsAffectedByLifting = getFloatsAffectedByLifting;
//sets this entire node to ECN and the face to null
const unsetNodesAtIJ = (i, j, warps, cns) => {
 ...
 */
const determineEdgeBehavior = (pick_id, j, valid_picks, warps, right, cns) => {
    ...
    const bottom = valid_picks[(0, utils_1.modStrict)(pick_id - 1, valid_picks.length)];
 ...
 * @returns
 */
const getFloatIndex = (float, all_float_objs) => {
 ...
 * @returns
 */
const setFloatACNS = (float, wefts, warps, layer, cns) => {
    //lift the entire float: 
    if (float.face) {
        const left_ndx = { i: (0, utils_1.modStrict)(float.left.i, wefts), j: (0, utils_1.modStrict)(float.left.j, warps), id: 2 };
        if ((0, exports.getNodeType)(left_ndx, warps, cns) !== 'ACN')
            console.error("LEFT NDX of float NOT AN ACN", left_ndx);
        const left_pair_ndx = { i: (0, utils_1.modStrict)(float.left.i - 1, wefts), j: (0, utils_1.modStrict)(float.left.j, warps), id: 3 };
        if ((0, exports.getNodeType)(left_pair_ndx, warps, cns) !== 'ACN')
            console.error("LEFT PAIR NDX of float NOT AN ACN", left_pair_ndx, (0, exports.getNodeType)(left_pair_ndx, warps, cns));
        const right_ndx = { i: (0, utils_1.modStrict)(float.right.i, wefts), j: (0, utils_1.modStrict)(float.right.j, warps), id: 3 };
        if ((0, exports.getNodeType)(right_ndx, warps, cns) !== 'ACN')
            console.error("RIGHT NDX of float NOT AN ACN", right_ndx);
        const right_pair_ndx = { i: (0, utils_1.modStrict)(float.right.i + 1, wefts), j: (0, utils_1.modStrict)(float.right.j, warps), id: 2 };
        if ((0, exports.getNodeType)(right_pair_ndx, warps, cns) !== 'ACN')
            console.error("RIGHT PAIR NDX of float NOT AN ACN", right_pair_ndx);
        ...
        const left_ndx = { i: (0, utils_1.modStrict)(float.left.i, wefts), j: (0, utils_1.modStrict)(float.left.j, warps), id: 0 };
        if ((0, exports.getNodeType)(left_ndx, warps, cns) !== 'ACN')
            console.error("LEFT NDX of float NOT AN ACN", left_ndx);
        const left_pair_ndx = { i: (0, utils_1.modStrict)(float.left.i, wefts), j: (0, utils_1.modStrict)(float.left.j - 1, warps), id: 1 };
        if ((0, exports.getNodeType)(left_pair_ndx, warps, cns) !== 'ACN')
            console.error("LEFT PAIR NDX of float NOT AN ACN", left_pair_ndx);
        const right_ndx = { i: (0, utils_1.modStrict)(float.right.i, wefts), j: (0, utils_1.modStrict)(float.right.j, warps), id: 1 };
        if ((0, exports.getNodeType)(right_ndx, warps, cns) !== 'ACN')
            console.error("RIGHT NDX of float NOT AN ACN", right_ndx);
        const right_pair_ndx = { i: (0, utils_1.modStrict)(float.right.i, wefts), j: (0, utils_1.modStrict)(float.right.j + 1, warps), id: 0 };
        if ((0, exports.getNodeType)(right_pair_ndx, warps, cns) !== 'ACN')
            console.error("RIGHT PAIR NDX of float NOT AN ACN", right_pair_ndx);
        cns = setLayer(left_ndx, warps, cns, layer);
        cns = setLayer(right_ndx, warps, cns, layer);
 ...
 * @returns
 */
const getFloatRelationships = (i, float, wefts, warps, all_floats, cns) => {
    ...
    if (i < 0)
        adj_i = (0, utils_1.modStrict)(i, wefts);
    //return if we've searched all rows
    if ((0, utils_1.modStrict)(i, wefts) == float.left.i)
        return [];
    //get all of the attached floats on i
    const attached = (0, exports.getAttachedFloats)(adj_i, float, warps, all_floats);
    const reltn = [];
    // console.log("ATTACHED ", attached.map(el => el.id));
    if (attached.length == 0) {
        const right_edge_ndx = { i: adj_i, j: float.right.j, id: 1 };
        const right_edge_type = (0, exports.getNodeType)(right_edge_ndx, warps, cns);
        const left_edge_ndx = { i: adj_i, j: float.left.j, id: 0 };
        const left_edge_type = (0, exports.getNodeType)(left_edge_ndx, warps, cns);
        let f_left = null;
        if (left_edge_type == "ACN" || right_edge_type == 'ACN') {
            ...
            if (left_edge_type == "ACN") {
                ...
                // x x - x x x  x x x         
                f_left = (0, exports.getWeftFloat)(left_edge_ndx.i, left_edge_ndx.j - 1, wefts, warps, all_floats);
                if (f_left !== null)
                    reltn.push({ kind: "BUILD", float: f_left });
            }
            if (right_edge_type == "ACN") {
                const f_right = (0, exports.getWeftFloat)(right_edge_ndx.i, right_edge_ndx.j + 1, wefts, warps, all_floats);
                if (f_right !== null) {
                    if (f_left == null)
                        reltn.push({ kind: "BUILD", float: f_right });
                    else if (f_left.id !== f_right.id)
                        reltn.push({ kind: "BUILD", float: f_right });
                }
            }
        }
...
exports.getFloatRelationships = getFloatRelationships;
 ...
 */
const initContactNeighborhoods = (dd) => {
    const width = (0, draft_1.warps)(dd);
    const height = (0, draft_1.wefts)(dd);
    const size = width * height * 4;
    let cns = new Array(size);
    ...
    for (let i = 0; i < height; i++) {
        for (let j = 0; j < width; j++) {
            ...
            const face = (0, draft_1.getCellValue)(dd[i][j]);
...
exports.initContactNeighborhoods = initContactNeighborhoods;
/**
 ...
 */
const getClosestACNOnWeft = (i, ndx, warps, cns) => {
    const acns = cns.filter(el => el.node_type == "ACN" && el.ndx.i == i);
    const closest = acns.reduce((acc, el) => {
        const dist = Math.abs(el.ndx.j - ndx.j);
        if (dist < acc.dist)
            return { dist: dist, ndx: el.ndx };
        return acc;
    }, { dist: 1000, ndx: null });
    return closest.ndx;
};
exports.getClosestACNOnWeft = getClosestACNOnWeft;
const getAllWeftFloats = (wefts, warps, cns) => {
    let floats = [];
    for (let i = 0; i < wefts; i++) {
        const row = (0, exports.getRowAsFloats)(i, warps, cns);
        floats = floats.concat(row);
    }
    return floats;
};
exports.getAllWeftFloats = getAllWeftFloats;
/**
 ...
 * @returns
 */
const setFloatBlocking = (wefts, warps, cns) => {
    //gets all front and back facing floats
    const all_floats = (0, exports.getAllWeftFloats)(wefts, warps, cns);
    all_floats.forEach((el, ndx) => {
        el.id = ndx;
    });
    // printFloats(all_floats.map(el => { return { id: el.id, float: el, touched: false } }));
    function hasBlockingRelationship(float, reltn) {
        ...
        if (reltn.find(el => el.kind == "BUILD") !== undefined) {
            reltn.forEach(el => {
                if (el.kind == "BUILD" && el.float !== null) {
                    if (float.blocking.find(fel => { var _a; return fel == ((_a = el.float) === null || _a === void 0 ? void 0 : _a.id); }) == undefined)
                        float.blocking.push(el.float.id); //this needs to push the FLOAT that is blocking, not the row
                }
            });
            return true;
        }
    ...
    for (let i = 0; i < wefts; i++) {
        ...
        floats.forEach(float => {
            ...
            if (float.face != null) {
                let check_row = i - 1;
                let reltn = (0, exports.getFloatRelationships)(check_row, float, wefts, warps, all_floats, cns);
                //console.log("RELTN ", reltn.map(el => el.kind), reltn.map(el => el.float?.id));
                while (hasBlockingRelationship(float, reltn) == false && (0, utils_1.modStrict)(check_row, wefts) != float.left.i) {
                    check_row--;
                    reltn = (0, exports.getFloatRelationships)(check_row, float, wefts, warps, all_floats, cns);
                }
            }
        });
    }
...
exports.setFloatBlocking = setFloatBlocking;
// /**
...
//  * @returns 
//  */
const updateCNs = (cns, wefts, warps, sim) => {
    const regions = [
    ...
    for (let i = 0; i < wefts; i++) {
        for (let j = 0; j < warps; j++) {
            ...
            const layer = (0, exports.getLayer)({ i, j, id: 0 }, warps, cns);
            for (const region of regions) {
                //find the next next acn above that shares the layer
                const ij = (0, exports.getNextCellOnLayer)(i, j, wefts, warps, layer, region.name, cns);
                if (ij == null) {
                    cns = setNodeType({ i, j, id: region.id }, warps, cns, 'ECN');
                }
                else {
                    const last_face = getFace({ i: ij.i, j: ij.j, id: 0 }, warps, cns);
                    cns = (0, exports.classifyNodeTypeBasedOnFaces)(face, last_face, { i, j, id: region.id }, warps, cns);
                }
                ...
                if (!sim.wefts_as_written) {
                    switch (region.name) {
                        case "above":
                            if (i == 0 && (0, exports.getNodeType)(ndx, warps, cns) !== 'ACN')
                                setNodeType(ndx, warps, cns, 'VCN');
                            break;
                        case "below":
                            if (i == wefts - 1 && (0, exports.getNodeType)(ndx, warps, cns) !== 'ACN')
                                setNodeType(ndx, warps, cns, 'VCN');
                            break;
                        case "left":
                            if (j == 0 && (0, exports.getNodeType)(ndx, warps, cns) !== 'ACN')
                                setNodeType(ndx, warps, cns, 'VCN');
                            break;
                        case "right":
                            if (j == warps - 1 && (0, exports.getNodeType)(ndx, warps, cns) !== 'ACN')
                                setNodeType(ndx, warps, cns, 'VCN');
                            break;
                    }
                }
...
exports.updateCNs = updateCNs;
const pullRows = (d, paths, cns) => {
    for (let i = 0; i < (0, draft_1.wefts)(d.drawdown); i++) {
        const path = (0, exports.getWeftPath)(paths, d.rowSystemMapping[i], d.rowShuttleMapping[i]);
        if (path != null) {
            cns = (0, exports.pullRow)(i, (0, draft_1.wefts)(d.drawdown), (0, draft_1.warps)(d.drawdown), path.pics, cns);
        }
    }
    return cns;
};
exports.pullRows = pullRows;
...
const pullRow = (i, wefts, warps, prev_i_list, cns) => {
    if (prev_i_list.length == 0)
        return cns;
    ...
    let obj = determineEdgeBehavior(ndx, starting_j, valid_pics, warps, direction, cns);
    cns = obj.cns;
...
exports.pullRow = pullRow;
const printFloats = (floats) => {
...
const getFloats = (wefts, warps, cns) => {
    //get weft floats; 
    let floats = [];
    for (let i = 0; i < wefts; i++) {
        floats = floats.concat((0, exports.getRowAsFloats)(i, warps, cns)).filter(float => !float.face);
    }
    for (let j = 0; j < warps; j++) {
        floats = floats.concat((0, exports.getColAsFloats)(j, wefts, warps, cns).filter(float => float.face));
    }
    //assign ids
...
* @returns
*/
const isolateLayers = (wefts, warps, floats, layer, cns, sim) => {
    floats = floats.filter(el => (0, exports.getLayer)(el.left, warps, cns) == 0);
    const floats_with_id = floats.map((el, ndx) => { return { id: ndx, float: el, touched: false }; });
    if (floats_with_id.length == 0)
        return cns;
    ...
    function liftFloat(float_ndx) {
        const float_obj = floats_with_id[float_ndx];
        if (float_obj.touched == true)
            return;
        ...
        attached = (0, exports.getFloatsAffectedByLifting)(float_ndx, floats_with_id, wefts, warps, (sim.lift_limit * layer));
        if (attached.length == 0)
            return;
    ...
    return (0, exports.isolateLayers)(wefts, warps, floats, ++layer, cns, sim);
};
exports.isolateLayers = isolateLayers;
/**
 ...
 * @returns
 */
const parseDrawdown = (d, cns, sim) => {
    // console.log("**************** NEW DRAFT LOADED **************", d)
    let paths = (0, exports.initWeftPaths)(d);
    paths = (0, exports.parseWeftPaths)(d, paths);
    const dd = d.drawdown;
    //START BY POPULATING THE CNS MAPS
    cns = (0, exports.updateCNs)(cns, (0, draft_1.wefts)(d.drawdown), (0, draft_1.warps)(d.drawdown), sim);
    //printCNs(cns, wefts(d.drawdown), warps(d.drawdown));
    if (sim.wefts_as_written) {
        cns = (0, exports.pullRows)(d, paths, cns);
        //update CNS after pull to reset warp aligned ACNS
        cns = (0, exports.updateCNs)(cns, (0, draft_1.wefts)(d.drawdown), (0, draft_1.warps)(d.drawdown), sim);
    }
    //gets all the weft floats
    const floats = (0, exports.getFloats)((0, draft_1.wefts)(dd), (0, draft_1.warps)(dd), cns);
    cns = (0, exports.isolateLayers)((0, draft_1.wefts)(dd), (0, draft_1.warps)(dd), floats, 1, cns, sim);
    (0, exports.printCNs)(cns, (0, draft_1.wefts)(dd), (0, draft_1.warps)(dd));
    return Promise.resolve(cns);
};
/**
 * update this to contact neighborhood
 */
const getDraftTopology = async (draft, sim) => {
    return (0, exports.initContactNeighborhoods)(draft.drawdown)
        .then(cns => {
        return parseDrawdown(draft, cns, sim);
    });
};
exports.getDraftTopology = getDraftTopology;
 ...
 */
const getBeatDistance = (beat_strength) => {
    if (beat_strength > 1 || beat_strength < 0)
        console.error("BEAT STRENGTH IS OUT OF BOUNDS ", beat_strength);
    if (beat_strength < 0)
        beat_strength = 0;
    if (beat_strength > 1)
        beat_strength = 1;
    return (0, utils_1.interpolate)(beat_strength, { min: 0, max: 300 });
};
exports.getBeatDistance = getBeatDistance;
/**
 *
 * @param warps
 * @param wefts
 ...
 * @returns
 */
const hasBlockingVtx = (warps, wefts, blocking_floats, vtx_list) => {
    if (blocking_floats.length == 0)
        return false;
    const has_blocking_vtx = blocking_floats.every(el => {
        const vtx_left = vtx_list.find(v => v.ndx.i == (0, utils_1.modStrict)(el.left.i, wefts) && v.ndx.j == (0, utils_1.modStrict)(el.left.j, warps));
        const vtx_right = vtx_list.find(v => v.ndx.i == (0, utils_1.modStrict)(el.right.i, wefts) && v.ndx.j == (0, utils_1.modStrict)(el.right.j, warps));
        return vtx_left !== undefined && vtx_right !== undefined;
    });
    return has_blocking_vtx;
};
exports.hasBlockingVtx = hasBlockingVtx;
const getMaterialFromPath = (i, paths, sim) => {
    var _a;
    const path = paths.find(el => el.pics.includes(i));
    if (path == undefined) {
        return null;
    }
    return (_a = sim.ms.find(el => el.id == path.material)) !== null && _a !== void 0 ? _a : null;
};
exports.getMaterialFromPath = getMaterialFromPath;
const getYarnHeightOffset = (blocking_i, paths, sim) => {
    const blocking_mat = (0, exports.getMaterialFromPath)(blocking_i, paths, sim);
    if (blocking_mat == null) {
        return 0;
    }
    return (blocking_mat.diameter / 2);
};
exports.getYarnHeightOffset = getYarnHeightOffset;
/**
 ...
 * @returns
 */
const getFloatVtxLeft = (float, warps, wefts, vtx_list) => {
    let j = float.left.j;
...
exports.getFloatVtxLeft = getFloatVtxLeft;
/**
 * finds the left edge of this float in the vertex list. Checks to make sure that the vertex is in range and that the vertex that matches is not a virtual vertex.
 * @param float
 * @param warps
 ...
 * @returns
 */
const getFloatVtxRight = (float, warps, wefts, vtx_list) => {
    let j = float.right.j;
...
exports.getFloatVtxRight = getFloatVtxRight;
const getBlockingVtx = (ndx, warps, cns, vtx_list) => {
    const cn = getCN(ndx, warps, cns);
    const blocking_vtx = cn.isect !== null ? (0, exports.getVertexForCN)(cn.isect, vtx_list) : null;
    return blocking_vtx;
};
exports.getBlockingVtx = getBlockingVtx;
/**
 ...
 * @returns
 */
const getYOfBlockingVtx = (blocking_vtx, paths, sim, verbose) => {
    let blocking_y = 0; //the y value of the highest vertex of the blocking floats. 
    if (blocking_vtx === null)
        return 0;
    blocking_y = blocking_vtx.vtx.y;
    if (verbose)
        console.log("BLOCKING Y ", blocking_y);
    const height_offset = (0, exports.getYarnHeightOffset)(blocking_vtx.ndx.i, paths, sim);
    return blocking_y + height_offset;
};
exports.getYOfBlockingVtx = getYOfBlockingVtx;
/**
 ...
 * @returns
 */
const getRepelForceAtVtx = (vtx, blocking_vtx, verbose) => {
    if (blocking_vtx === null)
        return -1;
...
exports.getRepelForceAtVtx = getRepelForceAtVtx;
/**
 * calculates the distance the vertex will be pushed by the force of the closest ACN.
 * @param force_repel
 * @returns
 */
const calculateYRepel = (force_repel, time, mass, verbose) => {
    if (verbose)
        console.log("FORCE REPEL ", force_repel, time);
    const a = force_repel / mass; //accelleration is F/mass
    const distance = .5 * Math.pow(a * time, 2);
    return distance;
};
exports.calculateYRepel = calculateYRepel;
const getBlockingFloatsForACN = (warps, float, all_floats) => {
    const blocking_list = float.blocking.filter(el => all_floats.find(f => f.id == el) !== undefined).map(el => all_floats.find(f => f.id == el));
    return blocking_list;
};
exports.getBlockingFloatsForACN = getBlockingFloatsForACN;
const getVertexForCN = (ndx, vtx_list) => {
...
exports.getVertexForCN = getVertexForCN;
const calcWarpVertexY = (ndx, vtx, paths) => {
    var _a, _b;
    const weft_i = ndx.i;
    const elig_paths = paths.filter(el => el.pics.includes(weft_i));
    if (elig_paths === undefined || elig_paths === null || elig_paths.length == 0)
        return vtx;
    const path = elig_paths[0].vtxs.filter(el => el.ndx.i == weft_i);
    //find the closest weft vertex to this path
    const closest_vtx = path.reduce((acc, el) => {
        const dist = Math.abs(el.vtx.x - vtx.x);
        if (dist < acc.dist)
            return { dist: dist, vtx: el };
        return acc;
    }, { dist: 100000, vtx: null });
    if (closest_vtx === undefined || closest_vtx === null)
        return vtx;
    vtx.y = (_b = (_a = closest_vtx.vtx) === null || _a === void 0 ? void 0 : _a.vtx.y) !== null && _b !== void 0 ? _b : 0;
    return vtx;
};
exports.calcWarpVertexY = calcWarpVertexY;
const calcWeftVertexY = (ndx, vtx, b, warps, wefts, vtx_list, paths, sim, cns, verbose = false) => {
    //INSERT - assume this is 200 px above the highest vtx. 
    if (verbose)
        console.log("INSERT Y ", vtx.y);
    //BEAT - assume 300 gets us as far as we need to go. 
    const y_beat = vtx.y - (30 * b);
    if (verbose)
        console.log("Y _ BEAT ", y_beat);
    const blocking_vtx = (0, exports.getBlockingVtx)(ndx, warps, cns, vtx_list);
    if (verbose)
        console.log("BLOCKING VTX ", blocking_vtx);
    const y_blocking = (0, exports.getYOfBlockingVtx)(blocking_vtx, paths, sim, verbose);
    if (verbose)
        console.log("Y BLOCKING ", y_blocking);
    vtx.y = Math.max(y_blocking, y_beat);
    const force_repel = (0, exports.getRepelForceAtVtx)(vtx, blocking_vtx, verbose);
    if (force_repel == -1) {
        vtx.y = Math.max((0, exports.getYarnHeightOffset)(0, paths, sim), y_beat);
    }
    else {
        if (verbose)
            console.log("REPEAL FORCE", force_repel);
        const y_repel = (0, exports.calculateYRepel)(force_repel, sim.time, sim.mass, verbose);
        if (verbose)
            console.log("REPEAL DIST", y_repel);
        vtx.y += y_repel;
    }
    if (verbose)
        console.log("RETURNING ", vtx.y);
    return vtx;
};
exports.calcWeftVertexY = calcWeftVertexY;
/**
 ...
 * @returns
 */
const computeThetaMax = (stretch) => {
    if (stretch > 1 || stretch < 0)
        console.error("STRETCH IS OUT OF BOUNDS ", stretch);
    return (0, utils_1.interpolate)(stretch, { min: Math.PI / 24, max: Math.PI / 4 });
};
exports.computeThetaMax = computeThetaMax;
/**
 ...
 */
const computeThetaBetweenVertices = (vtx1, vtx2) => {
    const x_diff = vtx2.vtx.x - vtx1.vtx.x;
    const y_diff = vtx2.vtx.y - vtx1.vtx.y;
    return Math.atan(y_diff / x_diff);
};
exports.computeThetaBetweenVertices = computeThetaBetweenVertices;
/**
 ...
 * @returns
 */
const computeYAdjustment = (vtx1, vtx2, theta_max) => {
    const x_diff = vtx2.vtx.x - vtx1.vtx.x;
    return Math.tan(theta_max) * x_diff;
};
exports.computeYAdjustment = computeYAdjustment;
/**
 ...
 */
const smoothPick = (pick, stretch, theta_max, spacing) => {
 ...
 */
const getClosestBlockingVertex = (ndx, vtx, warps, wefts, vtx_list, cns, verbose) => {
    if (vtx_list.length == 0)
        return -1;
    const weft_layer = (0, exports.getWeftLayer)(ndx, warps, cns);
    //get eligable blocking vertices that have already been added to the vtx list
    const eligable_blocking_vtxs = vtx_list.filter(el => (0, exports.getLayer)(el.ndx, warps, cns) == weft_layer);
    if (eligable_blocking_vtxs.length == 0)
        return -1;
    let min_dist = 10000;
    eligable_blocking_vtxs.forEach(el => {
        //initialize the distances to a large number
        let dist_square = 100000;
...
exports.getClosestBlockingVertex = getClosestBlockingVertex;
// }
/**
 ...
 * @returns
 */
const calcWeftVertexZ = (pos, face, layer, layer_spacing, warp_diameter, weft_diameter) => {
    if (face == null)
        console.error("FACE IS NULL in calcZ");
    const offset = warp_diameter / 2 + weft_diameter / 2;
    pos.z = layer * -layer_spacing;
    pos.z = (face) ? pos.z - offset : pos.z + offset;
    return pos;
};
exports.calcWeftVertexZ = calcWeftVertexZ;
const calcWarpVertexZ = (pos, face, layer, layer_spacing) => {
    if (face == null)
        console.error("FACE IS NULL in calcZ");
    pos.z = layer * -layer_spacing;
    return pos;
};
exports.calcWarpVertexZ = calcWarpVertexZ;
/**
 ...
 * @returns
 */
const createPlaceholderVertex = (ndx, y, z, d, sim) => {
    let pos = { x: 0, y: y, z: z };
    pos = (0, exports.calcX)(pos, ndx.j, sim.warp_spacing);
    return { ndx, vtx: pos, orientation: null };
};
const createWarpVertex = (ndx, d, cns, weft_paths, sim) => {
    const verbose = false;
    if (verbose)
        console.log("CREATING WARP VTX FOR ", ndx);
    const face = getFace(ndx, (0, draft_1.warps)(d.drawdown), cns);
    const edge = (ndx.id == 2) ? true : false; //left or right
    const orientation = face !== edge;
    let pos = { x: 0, y: 0, z: 0 };
    pos = (0, exports.calcX)(pos, ndx.j, sim.warp_spacing);
    pos = (0, exports.calcWarpVertexY)(ndx, pos, weft_paths);
    pos = (0, exports.calcWarpVertexZ)(pos, face, (0, exports.getLayer)(ndx, (0, draft_1.warps)(d.drawdown), cns), sim.layer_spacing);
 ...
 * 1 px = 1 mm
 */
const createWeftVertex = (ndx, fell, d, vtx_list, cns, paths, sim) => {
    ...
    const weft_diameter = (0, material_1.getDiameter)(weft_material_id, sim.ms);
    const warp_material_id = d.colShuttleMapping[ndx.j];
    const warp_diameter = (0, material_1.getDiameter)(warp_material_id, sim.ms);
    const face = getFace(ndx, (0, draft_1.warps)(d.drawdown), cns);
    const edge = (ndx.id == 0) ? true : false; //left or right
    const orientation = face !== edge;
    let pos = { x: 0, y: fell + pack_offset, z: 0 };
    pos = (0, exports.calcX)(pos, ndx.j, sim.warp_spacing);
    pos = (0, exports.calcWeftVertexY)(ndx, pos, sim.pack, (0, draft_1.warps)(d.drawdown), (0, draft_1.wefts)(d.drawdown), vtx_list, paths, sim, cns, verbose);
    pos = (0, exports.calcWeftVertexZ)(pos, face, (0, exports.getLayer)(ndx, (0, draft_1.warps)(d.drawdown), cns), sim.layer_spacing, warp_diameter, weft_diameter);
    if (verbose)
        console.log("CREATED VTX ", ndx, pos);
    return { ndx, vtx: pos, orientation };
};
/**
...
exports.initWeftPaths = initWeftPaths;
/**
...
exports.parseWeftPaths = parseWeftPaths;
const getFlatVtxList = (paths) => {
...
exports.getFlatVtxList = getFlatVtxList;
const getWeftPath = (paths, system, material) => {
    var _a;
    return (_a = paths.find(el => el.material == material && el.system == system)) !== null && _a !== void 0 ? _a : null;
};
exports.getWeftPath = getWeftPath;
 ...
 * @returns
 */
const createWarpPathFromWeftPaths = (wefts, min_y, max_y, weft_paths, j, sim) => {
    const warp_path = [];
    ...
    //     }
    // }
    const starting_vtx = { ndx: { i: -1, j: j, id: 2 }, vtx: { x: x, y: min_y - 10, z: z }, orientation: null };
    if (warp_path.length > 0)
        starting_vtx.vtx.z = warp_path[0].vtx.z;
    warp_path.unshift(starting_vtx);
    const ending_vtx = { ndx: { i: wefts, j: j, id: 2 }, vtx: { x: x, y: max_y + 10, z: z }, orientation: null };
    if (warp_path.length > 0)
        ending_vtx.vtx.z = warp_path[warp_path.length - 1].vtx.z;
    warp_path.push(ending_vtx);
    return warp_path;
};
exports.createWarpPathFromWeftPaths = createWarpPathFromWeftPaths;
const getMinY = (weft_paths) => {
...
const addPlaceholderVertices = (temp_pic, i, direction, warpnum, cns, draft, sim) => {
    let start_vtx = null;
    let end_vtx = null;
    ...
    if (start_vtx !== null)
        temp_pic.unshift(start_vtx);
    if (end_vtx !== null)
        temp_pic.push(end_vtx);
    return temp_pic;
};
exports.addPlaceholderVertices = addPlaceholderVertices;
/**
 ...
 * @returns
 */
const getOrientation = (el, el2, warps, cns) => {
    ...
    if (setAndOppositeFaces(el_type, el2_type))
        return el_type; //return what the first vtx is. 
    else {
 ...
 * @returns
 */
const pruneDuplicateWeftVertices = (temp_pic) => {
    return temp_pic.reduce((acc, el) => {
...
exports.pruneDuplicateWeftVertices = pruneDuplicateWeftVertices;
/**
 *
 * @param temp_pic
 * @returns
 */
const pruneDuplicateWarpVertices = (temp_pic) => {
    return temp_pic.reduce((acc, el) => {
...
exports.pruneDuplicateWarpVertices = pruneDuplicateWarpVertices;
/**
 ...
 * @returns
 */
const reduceVerticesAndSetOrientation = (paths, warps, cns, sim) => {
    paths.forEach(path => {
        ...
        right_edges.forEach(el => {
            ...
            if (next_left_edge_id !== -1) {
                ...
                const orientation = (0, exports.getOrientation)(el, next_left_edge, warps, cns);
                if (orientation !== null) {
...
exports.reduceVerticesAndSetOrientation = reduceVerticesAndSetOrientation;
const getWeftLayer = (ndx, warps, cns) => {
    ...
    for (let j_offset = 0; j_offset < warps - 1 && !found; j_offset++) {
        const j_adj = (0, utils_1.modStrict)(ndx.j - j_offset, warps);
...
exports.getWeftLayer = getWeftLayer;
const getWarpLayer = (ndx, wefts, warps, cns) => {
    //walk up until you hit an ACN - then return it's layer. 
    let found = false;
    let layer_left = 0, layer_right = 0;
    for (let i_offset = 0; i_offset < wefts - 1 && !found; i_offset++) {
        const i_adj = (0, utils_1.modStrict)(ndx.i - i_offset, wefts);
...
exports.getWarpLayer = getWarpLayer;
const pruneWarps = (wefts, warps, cns) => {
    const acns = cns
        .filter(el => el.node_type == 'ACN')
        .filter(el => el.ndx.id >= 2)
        .filter(el => (0, exports.getWarpLayer)(el.ndx, wefts, warps, cns) == (0, exports.getWeftLayer)(el.ndx, warps, cns));
    return acns;
};
exports.pruneWarps = pruneWarps;
const pruneWeftsAndSetCNBlocking = (wefts, warps, cns) => {
    const acns = cns
        .filter(el => el.node_type == 'ACN')
        .filter(el => el.ndx.id < 2)
        .filter(el => (0, exports.getWeftLayer)(el.ndx, warps, cns) == (0, exports.getWarpLayer)(el.ndx, wefts, warps, cns));
    acns.forEach(acn => {
        const layer = (0, exports.getWeftLayer)(acn.ndx, warps, cns);
        let potential_blocks = acns.filter(el => (0, exports.getWeftLayer)(el.ndx, warps, cns) == layer && el.ndx.i < acn.ndx.i && el.ndx.id < 2);
        //prune this list so it is just the max i
        const max_i = potential_blocks.reduce((acc, el) => {
        ...
        const closest_j = potential_blocks.reduce((acc, el) => {
...
exports.pruneWeftsAndSetCNBlocking = pruneWeftsAndSetCNBlocking;
const placeWarps = (draft, weft_paths, cns, sim) => {
    const max_y = weft_paths.reduce((acc, el) => {
        return Math.max(acc, el.vtxs.reduce((acc, el) => {
            return Math.max(acc, el.vtx.y);
        }, 0));
    }, 0);
    const pruned_cns = (0, exports.pruneWarps)((0, draft_1.wefts)(draft.drawdown), (0, draft_1.warps)(draft.drawdown), cns);
    ...
    for (let j = 0; j < (0, draft_1.warps)(draft.drawdown); j++) {
        ...
        path.vtxs = (0, exports.pruneDuplicateWarpVertices)(path.vtxs);
        ...
        if (path.vtxs.length > 0) {
            ...
            path.vtxs.push({ ndx: { i: (0, draft_1.wefts)(draft.drawdown), j: j, id: 3 }, vtx: { x: last_vtx.vtx.x, y: max_y + 10, z: last_vtx.vtx.z }, orientation: null });
            warp_paths.push(path);
        }
        else {
            let start_vtx = { x: 0, y: -10, z: 0 };
            start_vtx = (0, exports.calcX)(start_vtx, j, sim.warp_spacing);
            path.vtxs.unshift({ ndx: { i: -1, j: j, id: 2 }, vtx: start_vtx, orientation: null });
            path.vtxs.push({ ndx: { i: (0, draft_1.wefts)(draft.drawdown), j: j, id: 3 }, vtx: { x: start_vtx.x, y: max_y + 10, z: start_vtx.z }, orientation: null });
        }
    }
    return Promise.resolve(warp_paths);
};
exports.placeWarps = placeWarps;
const followTheWefts = (draft, cns, sim) => {
    // printDrawdown(draft.drawdown);
    // printCNs(cns, wefts(draft.drawdown), warps(draft.drawdown));
    const pruned_cns = (0, exports.pruneWeftsAndSetCNBlocking)((0, draft_1.wefts)(draft.drawdown), (0, draft_1.warps)(draft.drawdown), cns);
    // console.log("PRUNED CNS ", pruned_cns.map(el => el.isect));
    const warpnum = (0, draft_1.warps)(draft.drawdown);
    //get a list of the unique system-material combinations of this weft. 
    const paths = (0, exports.initWeftPaths)(draft);
    let fell_y = 0;
    ...
    for (let i = 0; i < (0, draft_1.wefts)(draft.drawdown); i++) {
        ...
        const path = (0, exports.getWeftPath)(paths, system, material);
        if (path === undefined || path === null) {
            return Promise.reject("weft path with system and material not found");
        }
        const flat_vtx_list = (0, exports.getFlatVtxList)(paths);
        ...
        temp_pic = (0, exports.pruneDuplicateWeftVertices)(temp_pic);
        ...
        if (sim.use_smoothing) {
            temp_pic = (0, exports.smoothPick)(temp_pic, (0, material_1.getMaterialStretch)(sim.ms[material]), sim.max_theta, sim.warp_spacing);
        }
        //  console.log("AFTER SMOOTHING ", i, temp_pic.map(el => el.vtx.y));
        //if we are rending full width add placeholder verticies and make sure they match the layer of the weft. 
        if (!sim.wefts_as_written)
            temp_pic = (0, exports.addPlaceholderVertices)(temp_pic, i, direction, warpnum, cns, draft, sim);
        //   console.log("AFTER PLACEHOLDER ", i, temp_pic.map(el => el.vtx.y));
...
exports.followTheWefts = followTheWefts;
/**
...
exports.calcClothHeightOffsetFactor = calcClothHeightOffsetFactor;
...
// }
// DEBUGGING FUNCTIONS
const printCNs = (cns, wefts, warps) => {
    ...
    for (let i = 0; i < wefts; i++) {
        ...
        row_ln_3 = `  `;
        for (let j = 0; j < warps; j++) {
            let cn_l = (0, exports.getNodeType)({ i, j, id: 0 }, warps, cns).substring(0, 1);
            let cn_r = (0, exports.getNodeType)({ i, j, id: 1 }, warps, cns).substring(0, 1);
            let cn_t = (0, exports.getNodeType)({ i, j, id: 2 }, warps, cns).substring(0, 1);
            let cn_b = (0, exports.getNodeType)({ i, j, id: 3 }, warps, cns).substring(0, 1);
            if (cn_l == "P")
                cn_l = "-";
            if (cn_r == "P")
                cn_r = "-";
            ...
            if (face_val == false)
                face = "o";
            cn_l = (cn_l == "A") ? (0, exports.getLayer)({ i, j, id: 0 }, warps, cns).toString() : cn_l;
            cn_r = (cn_r == "A") ? (0, exports.getLayer)({ i, j, id: 1 }, warps, cns).toString() : cn_r;
            cn_t = (cn_t == "A") ? (0, exports.getLayer)({ i, j, id: 2 }, warps, cns).toString() : cn_t;
            cn_b = (cn_b == "A") ? (0, exports.getLayer)({ i, j, id: 3 }, warps, cns).toString() : cn_b;
            row_ln_1 += `   ${cn_t}   `;
...
exports.printCNs = printCNs;
const printYValues = (cns, wefts, warps, mode) => {
    ...
    for (let i = 0; i < wefts; i++) {
        ...
        for (let j = 0; j < warps; j++) {
            if (mode) {
                row.push((0, exports.getLayer)({ i, j, id: 0 }, warps, cns) + "-" + (0, exports.getNodeType)({ i, j, id: 0 }, warps, cns) + ", " + (0, exports.getLayer)({ i, j, id: 1 }, warps, cns) + "-" + (0, exports.getNodeType)({ i, j, id: 1 }, warps, cns));
            }
            else {
                row.push((0, exports.getLayer)({ i, j, id: 2 }, warps, cns) + "-" + (0, exports.getNodeType)({ i, j, id: 2 }, warps, cns) + ", " + (0, exports.getLayer)({ i, j, id: 3 }, warps, cns) + "-" + (0, exports.getNodeType)({ i, j, id: 3 }, warps, cns));
            }
        }
        layer_map.push(row);
    }
...
exports.printYValues = printYValues;
