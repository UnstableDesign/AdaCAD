...
We'll walk you through the process of creating [dataflows](../reference/glossary/dataflow.md) for assigning shaded structures like <OpLink name='shaded_satin' /> to regions of an image using the <OpLink name='imagemap' /> operation. Additionally, we'll help you format these drafts for weaving on TC2 digital looms.
...
We'll walk you through the process of creating [dataflows](../reference/glossary/dataflow.md) that produce patterned threading sequences using the <OpLink name='warp_profile' /> operation. We'll then use the <OpLink name='make_drawdown' /> operation to combine these threadings with treadling and tieup drafts.
