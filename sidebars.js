  ...
  learnSidebar: [
    ...
    // },
    {
      ...
      link: {
        ...
        title: 'Tutorials',
        description: 'Tutorials are designed to walk you through making workspaces to accomplish common tasks'},
        items: [
...
//insert reference sidebar
{
  ...
  link: {
    type: 'generated-index',
    title: 'Reference',
    description: 'Where tutorials guide you through activities, the reference section provides resources and descriptions of the various parts of the software. This includes a glossary of the language we use, a list of every operation the software currently supports, and a description of the interface features',
  },
  items:[
{ 
  type:'category',
