...
// ];
   ...
   * @param default_cell - the palettes default render size from which scale takes place
   */
  rescale(scale:number, default_cell: number){


    // //if this has been generated by an operation draw it directly under that operation
    ...
    // }else{
    //   //if it doesn't have inputs or is a siblilng
  ...
  designActionChange(e){
    ...
    public onSave(e: any, default_cell: number) {
      ...
      if (e.type === "bmp"){
        ...
        this.rescale(prev_scale, default_cell);
      }
      else if (e.type === "ada"){
        let link = e.downloadLink.nativeElement;
